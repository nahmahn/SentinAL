...
from aeternus.browser.cloud.views import CloudBrowserParams
from aeternus.config import CONFIG
from aeternus.utils import _log_pretty_path, logger
...
# Using constants from central location in aeternus.config
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	proxy: ProxySettings | None = Field(
		default=None,
		description='Proxy settings. Use aeternus.browser.profile.ProxySettings(server, bypass, username, password)',
	)
