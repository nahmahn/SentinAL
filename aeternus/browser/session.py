...
from aeternus.browser.cloud.cloud import CloudBrowserAuthError, CloudBrowserClient, CloudBrowserError

# CDP logging is now handled by setup_logging() in logging_config.py
# It automatically sets CDP logs to the same level as aeternus logs
from aeternus.browser.cloud.views import CloudBrowserParams, CreateBrowserRequest, ProxyCountryCode
from aeternus.browser.events import (
...
from aeternus.browser.profile import BrowserProfile, ProxySettings
from aeternus.browser.views import BrowserStateSummary, TabInfo
from aeternus.dom.views import DOMRect, EnhancedDOMTreeNode, TargetInfo
from aeternus.observability import observe_debug
from aeternus.utils import _log_pretty_url, create_task_with_error_handling, is_new_tab_page

if TYPE_CHECKING:
	from aeternus.actor.page import Page
	from aeternus.browser.demo_mode import DemoMode
...
class BrowserSession(BaseModel):
	...
	def logger(self) -> Any:
		...
		# 	self._logger = logging.getLogger(f'aeternus.{self}')
		return logging.getLogger(f'aeternus.{self}')
	...
	def model_post_init(self, __context) -> None:
		...
		from aeternus.browser.watchdog_base import BaseWatchdog
	...
	async def kill(self) -> None:
		...
		from aeternus.browser.events import SaveStorageStateEvent
	...
	async def new_page(self, url: str | None = None) -> 'Page':
		...
		from aeternus.actor.page import Page as Target
	...
	async def get_pages(self) -> list['Page']:
		...
		# Import here to avoid circular import
		from aeternus.actor.page import Page as PageActor
	...
	async def attach_all_watchdogs(self) -> None:
		...
		from aeternus.browser.watchdogs.aboutblank_watchdog import AboutBlankWatchdog

		# from aeternus.browser.crash_watchdog import CrashWatchdog
		from aeternus.browser.watchdogs.default_action_watchdog import DefaultActionWatchdog
		from aeternus.browser.watchdogs.dom_watchdog import DOMWatchdog
		from aeternus.browser.watchdogs.downloads_watchdog import DownloadsWatchdog
		from aeternus.browser.watchdogs.local_browser_watchdog import LocalBrowserWatchdog
		from aeternus.browser.watchdogs.permissions_watchdog import PermissionsWatchdog
		from aeternus.browser.watchdogs.popups_watchdog import PopupsWatchdog
		from aeternus.browser.watchdogs.recording_watchdog import RecordingWatchdog
		from aeternus.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
		from aeternus.browser.watchdogs.security_watchdog import SecurityWatchdog
		from aeternus.browser.watchdogs.storage_state_watchdog import StorageStateWatchdog
	...
	async def connect(self, cdp_url: str | None = None) -> Self:
		...
		try:
			...
			from aeternus.browser.session_manager import SessionManager
			...
			from aeternus.utils import is_new_tab_page
	...
	async def navigate_to(self, url: str, new_tab: bool = False) -> None:
		...
		"""
		from aeternus.browser.events import NavigateToUrlEvent
	...
	async def get_dom_element_at_coordinates(self, x: int, y: int) -> EnhancedDOMTreeNode | None:
		...
		"""
		from aeternus.dom.views import NodeType
