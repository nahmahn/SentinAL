...
from aeternus.agent.message_manager.views import MessageManagerState
from aeternus.browser.views import BrowserStateHistory
from aeternus.dom.views import DEFAULT_INCLUDE_ATTRIBUTES, DOMInteractedElement, DOMSelectorMap

# from aeternus.dom.history_tree_processor.service import (
# 	DOMElementNode,
# 	DOMHistoryElement,
# 	HistoryTreeProcessor,
# )
# from aeternus.dom.views import SelectorMap
from aeternus.filesystem.file_system import FileSystemState
...
class AgentOutput(BaseModel):
	...
	recommendations: list[str] | None = Field(default=None, description="Suggested next actions for the user")
...
class AgentHistoryList(BaseModel, Generic[AgentStructuredOutput]):
	...
	# 	"""
	# 	from aeternus.agent.playwright_script_generator import PlaywrightScriptGenerator
