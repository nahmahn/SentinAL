...
from aeternus import BrowserSession
from aeternus.code_use import create_namespace
...
def session_to_python_script(agent: CodeAgent) -> str:
	...
	lines.append('from aeternus import BrowserSession\n')
	lines.append('from aeternus.code_use import create_namespace\n\n')
