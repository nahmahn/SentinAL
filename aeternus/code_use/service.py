...
from aeternus.browser.profile import BrowserProfile
...
from aeternus.tokens.views import UsageSummary
from aeternus.tools.service import CodeAgentTools, Tools
...
class CodeAgent:
	...
	def __init__(
		...
		**kwargs,
		...
		base_tmp = Path('/tmp')
		self.agent_directory = base_tmp / f'aeternus_code_agent_{self.id}_{timestamp}'
		...
		self.version = get_aeternus_version()
		try:
