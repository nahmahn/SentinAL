...
@cache
def get_aeternus_version() -> str:
	"""Get the browser-use package version using the same logic as Agent._set_aeternus_version_and_source"""
	try:
...
async def check_latest_aeternus_version() -> str | None:
